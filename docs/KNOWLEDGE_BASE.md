...
Ritmo is a productivity system that aligns work with the body's natural biological rhythms. It does not only ask *what to do*, but *when to do it* to get the best possible result based on the energy and cognitive capacity available at each moment of the day.
