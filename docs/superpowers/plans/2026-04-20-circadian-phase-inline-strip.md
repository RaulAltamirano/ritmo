    ...
    <div v-else-if="currentPhase">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
          <span class="text-base leading-none" aria-hidden="true">{{ currentPhase.emoji }}</span>
      ...
      <div class="w-full h-0.5 bg-gray-100 dark:bg-gray-800 rounded-full mt-3 overflow-hidden">
        <div
