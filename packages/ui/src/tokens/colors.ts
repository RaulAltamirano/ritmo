...
export const semanticColors = {
  ...
  primary: {
    ...
    400: 'bg-blue-400 text-white border-blue-600',
  ...
  secondary: {
    ...
    400: 'bg-neutral-400 text-white border-neutral-600',
    500: 'bg-neutral-500 text-white border-neutral-700',
  ...
  success: {
    ...
    400: 'bg-green-400 text-white border-green-600',
    500: 'bg-green-500 text-white border-green-700',
  ...
  warning: {
    ...
    400: 'bg-yellow-400 text-white border-yellow-600',
    500: 'bg-yellow-500 text-white border-yellow-700',
    600: 'bg-yellow-600 text-white border-yellow-800',
  ...
  error: {
    ...
    400: 'bg-red-400 text-white border-red-600',
  ...
  info: {
    ...
    400: 'bg-cyan-400 text-white border-cyan-600',
    500: 'bg-cyan-500 text-white border-cyan-700',
...
export function getColorVariant(variant: keyof typeof semanticColors, shade?: string) {
  ...
  if (!colorMap) {
    console.warn(`Color variant not found: ${variant}`)
    return ''
  }
...
export function getStateColor(
  ...
  if (!stateMap) {
    console.warn(`State color not found: ${variant}`)
    return ''
  }
...
export function getFormColor(
  ...
  if (!formMap) {
    console.warn(`Form color not found: ${type}`)
    return ''
  }
