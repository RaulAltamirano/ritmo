...
<template>
  <div class="mx-auto max-w-3xl space-y-10 pb-24">
    ...
    <section class="space-y-2">
      ...
      <div v-if="pointerVisible" data-testid="pointer-event" class="text-sm text-green-600">
        pointer handled
      </div>
    </section>
    ...
    <section class="space-y-2">
      ...
      <BaseButton data-testid="disabled-button" disabled @click="showClick">Disabled</BaseButton>
    </section>
    ...
    <section class="space-y-2">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <BaseButton data-testid="secondary-button" variant="secondary">Secondary</BaseButton>
