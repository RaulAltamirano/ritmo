    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <div :class="typography.getBodyTypography('small').value">
          <a href="#" :class="[
            ...
            'font-medium text-gray-600 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300 transition-colors',
      ...
      <div class="text-center">
        <p :class="[
          ...
          <a href="#" :class="[
            typography.getBodyTypography('small').value,
            'font-medium text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 transition-colors',
