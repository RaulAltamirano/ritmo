  ...
  <BaseCard variant="simple" padding="lg" class="max-w-md w-full">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <BaseInput
        ...
        :disabled="isLoading"
        :right-icon="showPassword ? Eye : EyeOff"
      ...
      <div v-if="form.password" class="space-y-2">
        <div class="flex items-center space-x-2">
          ...
          <span
            ...
            :class="[typography.getBodyTypography('small').value]"
          >
      ...
      <BaseInput
        ...
        :disabled="isLoading"
        :right-icon="showConfirmPassword ? Eye : EyeOff"
      ...
      <div v-if="form.confirmPassword" class="flex items-center space-x-1">
        <BaseIcon
          :icon="passwordsMatch ? CheckCircle : XCircle"
          size="sm"
      ...
      <div class="text-center">
        ...
        >
          ...
          <a
            href="#"
            class="font-medium text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 transition-colors"
            :class="[typography.getBodyTypography('small').value]"
