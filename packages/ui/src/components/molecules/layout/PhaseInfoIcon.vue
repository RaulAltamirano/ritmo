<template>
  <div class="relative group/icon" :title="title">
    ...
    <!-- Tooltip mejorado -->
    <div
      class="absolute px-4 py-3 text-sm rounded-xl shadow-2xl backdrop-blur-md opacity-0 group-hover/icon:opacity-100 transition-all duration-500 ease-out pointer-events-none z-20 transform translate-y-2 scale-95 group-hover/icon:translate-y-0 group-hover/icon:scale-100"
      :class="[
        // En mobile: aparece arriba, en desktop: aparece abajo
        'sm:top-full sm:right-0 sm:mt-4 sm:bottom-auto sm:mb-0',
        'bottom-full right-0 mb-4 top-auto mt-0',
        maxWidth,
        darkMode
    ...
    >
      ...
      <div
        ...
        :class="[
          ...
          'sm:bottom-full sm:right-4 sm:border-b-4 sm:border-t-0',
          'top-full right-4 border-t-4 border-b-0',
          darkMode
