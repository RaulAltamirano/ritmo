...
<template>
  <button
    ...
    class="switch relative inline-block h-6 w-12 rounded-full shadow-md transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1" :class="[
  ...
  >
    <span
      class="slider-handle absolute top-1 h-4 w-4 rounded-full bg-white shadow-md transition-all duration-300" :class="[
    ...
    <div
      ...
      aria-hidden="true"
    >
      <div class="h-3 w-3 animate-spin rounded-full border-2 border-white border-t-transparent" />
    </div>
