...
<template>
    <div class="space-y-4">
        <!-- Card skeleton items -->
        <div v-for="n in count" :key="n" class="group relative bg-surface border border-outline rounded-xl p-6" :class="[
            ...
            <div v-if="showContent" class="space-y-4">
                ...
                <div v-else-if="contentType === 'grid'" class="grid gap-4" :class="[
                    ...
                    <div v-for="item in gridColumns" :key="item" class="bg-surface-raised/50 rounded-lg p-4">
