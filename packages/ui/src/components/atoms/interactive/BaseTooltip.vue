    ...
    <Teleport to="body">
      <Transition name="tooltip" appear @enter="handleEnter" @leave="handleLeave">
        <div
          ...
          :id="tooltipId"
          ref="tooltipRef"
          class="fixed z-[99999] pointer-events-none min-w-[280px] max-w-sm lg:max-w-md sm:min-w-[280px] min-w-[260px] px-4 py-3 sm:px-5 sm:py-4 text-sm leading-relaxed rounded-2xl border border-transparent transition-all duration-300 ease-out transform-gpu backdrop-blur-xl will-change-transform shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04),0_0_0_1px_rgba(255,255,255,0.1)] dark:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.25),0_10px_10px_-5px_rgba(0,0,0,0.1),0_0_0_1px_rgba(255,255,255,0.05)]"
...
<style scoped>
  ...
  .dark
    .shadow-\[0_20px_25px_-5px_rgba\(0\,0\,0\,0\.25\)\,0_10px_10px_-5px_rgba\(0\,0\,0\,0\.1\)\,0_0_0_1px_rgba\(255\,255\,255\,0\.05\)\] {
    box-shadow:
