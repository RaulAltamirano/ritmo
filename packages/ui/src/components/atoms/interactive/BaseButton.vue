<template>
  <button ref="buttonRef" :id="buttonId" :class="buttonClasses" :disabled="disabled || loading" :type="type"
    role="button" :aria-label="ariaLabel" :aria-busy="loading" :aria-pressed="pressed" :aria-expanded="expanded"
...
import { useAtomicDesign, useColors, useId, useTypography } from '@ritmo/ui'
...
onMounted(() => {
  if (typeof window !== 'undefined') {
    ...
    // Event listeners para modificadores de teclado
