...
<template>
  <div class="inline-flex items-center justify-center" :class="[sizeClasses, className]" role="status"
    ...
    <div v-else-if="validVariant === 'dots'" class="flex items-center space-x-1" :class="[dotsContainerClasses]">
      <div v-for="i in 3" :key="i" class="rounded-full animate-bounce-subtle" :class="[dotClasses]" :style="{
