...
<template>
  <div class="inline-flex flex-col items-center justify-center animate-bounce" :class="[
    ...
    <div class="flex items-center justify-center">
      <svg class="transition-all duration-300 ease-out will-change-transform" :class="[
        logoClasses,
    ...
    <div v-if="showText" class="max-w-xs mx-auto text-center sm:max-w-[200px]">
      <p class="transition-colors duration-200" :class="[getLoadingTypography(), textClasses]">
        {{ loadingText }}
      </p>
    </div>
  </div>
