...
<template>
  <!-- Main navbar (top) -->
  <nav
    class="ritmo-app-nav fixed top-0 left-0 right-0 z-[9999] border-0 shadow-none outline-none ring-0 antialiased [backface-visibility:hidden] [transform:translate3d(0,0,0)]"
    :class="[showMobileMenu ? 'min-h-16' : 'h-16']"
    role="navigation"
