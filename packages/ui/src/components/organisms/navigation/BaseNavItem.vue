...
<template>
  <component
    :is="as"
    v-bind="linkProps"
    class="flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-canvas relative group"
    :class="[
      isActive
