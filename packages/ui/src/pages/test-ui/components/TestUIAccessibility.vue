    ...
    <div
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="space-y-4">
          ...
          <!-- Color Contrast Test -->
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Color Contrast Test</label>
            <div class="flex gap-2">
              <input type="color" v-model="foregroundColor"
                class="w-12 h-10 rounded border border-gray-300 dark:border-gray-600" aria-label="Foreground color" />
              <input type="color" v-model="backgroundColor"
                class="w-12 h-10 rounded border border-gray-300 dark:border-gray-600" aria-label="Background color" />
              <div class="flex-1 p-2 rounded border border-gray-300 dark:border-gray-600"
          ...
          <!-- Focus Test -->
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Focus Test</label>
            <div class="flex gap-2">
          ...
          <!-- Screen Reader Test -->
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Screen Reader Test</label>
            <div class="flex gap-2">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <div v-for="test in accessibilityTests" :key="test.id"
              class="flex items-center justify-between p-3 rounded-lg border" :class="test.passed
                  ? 'bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-700'
                  : 'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-700'
                ">
              <div class="flex items-center gap-2">
                <div class="w-2 h-2 rounded-full" :class="test.passed ? 'bg-green-500' : 'bg-red-500'"></div>
      ...
      <div class="flex flex-wrap gap-3">
        <BaseButton variant="primary" size="sm" @click="runAllTests" :loading="isRunningTests">
          Run All Tests
        </BaseButton>
