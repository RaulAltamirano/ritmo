    ...
    <div
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div
          ...
          <div class="space-y-2">
            <div class="flex justify-between">
              <span class="text-xs text-purple-600 dark:text-purple-400">Cache Hits:</span>
              <span class="text-xs font-medium text-purple-800 dark:text-purple-200">{{
                performanceMetrics.cacheHits
                }}</span>
            </div>
            <div class="flex justify-between">
              <span class="text-xs text-purple-600 dark:text-purple-400">Render Time:</span>
              <span class="text-xs font-medium text-purple-800 dark:text-purple-200">{{
        ...
        <div
          ...
          <div class="space-y-2">
            <div class="flex justify-between">
              <span class="text-xs text-orange-600 dark:text-orange-400">Reduced Motion:</span>
              <span class="text-xs font-medium text-orange-800 dark:text-orange-200">{{
                accessibilityInfo.prefersReducedMotion ? 'Yes' : 'No'
                }}</span>
            </div>
            <div class="flex justify-between">
              <span class="text-xs text-orange-600 dark:text-orange-400">High Contrast:</span>
              <span class="text-xs font-medium text-orange-800 dark:text-orange-200">{{
        ...
        <div
          ...
          <div class="space-y-2">
            <div class="flex justify-between">
              <span class="text-xs text-red-600 dark:text-red-400">Should Animate:</span>
              <span class="text-xs font-medium text-red-800 dark:text-red-200">{{
                shouldAnimate ? 'Yes' : 'No'
                }}</span>
            </div>
            <div class="flex justify-between">
              <span class="text-xs text-red-600 dark:text-red-400">Should Transition:</span>
              <span class="text-xs font-medium text-red-800 dark:text-red-200">{{
        ...
        <div
          ...
          <div class="space-y-2">
            <div class="flex justify-between">
              <span class="text-xs text-indigo-600 dark:text-indigo-400">Focus Trap:</span>
              <span class="text-xs font-medium text-indigo-800 dark:text-indigo-200">Active</span>
            </div>
            <div class="flex justify-between">
              <span class="text-xs text-indigo-600 dark:text-indigo-400">Keyboard Nav:</span>
              <span class="text-xs font-medium text-indigo-800 dark:text-indigo-200">Enabled</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex gap-2">
              <BaseButton variant="primary" size="sm" @click="setTheme('light')"
                :class="{ 'ring-2 ring-blue-500': currentTheme === 'light' }">
                Light
              </BaseButton>
              <BaseButton variant="secondary" size="sm" @click="setTheme('dark')"
                :class="{ 'ring-2 ring-blue-500': currentTheme === 'dark' }">
                Dark
              </BaseButton>
              <BaseButton variant="outline" size="sm" @click="setTheme('auto')"
          ...
          <!-- Typography Scale -->
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Typography Scale</label>
            <div class="space-y-1">
          ...
          <!-- Performance Test -->
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Performance Test</label>
            <div class="flex gap-2">
              <BaseButton variant="primary" size="sm" @click="testPerformance" :loading="isTestingPerformance">
                Test Performance
              </BaseButton>
          ...
          <div class="space-y-3">
            <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
              ...
              <div class="grid grid-cols-2 gap-2 text-xs">
                ...
                <span class="text-gray-600 dark:text-gray-400">• useMotionPreferences</span>
                <span class="text-gray-600 dark:text-gray-400">• useFocusManagement</span>
                <span class="text-gray-600 dark:text-gray-400">• useKeyboardNavigation</span>
                <span class="text-gray-600 dark:text-gray-400">• useVueUseEnhanced</span>
              </div>
            </div>
