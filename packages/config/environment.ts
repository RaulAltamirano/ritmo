...
export function loadEnvironmentConfig(): EnvironmentConfig {
  ...
  const baseConfig: EnvironmentConfig = {
    server: {
      ...
      environment: env as EnvironmentConfig['server']['environment'],
    },
...
export function validateEnvironment(): string[] {
  ...
  if (!config.security.jwt.secret || config.security.jwt.secret.includes('fallback')) {
  ...
  if (
    ...
    errors.push('JWT_REFRESH_SECRET is required and must not be the fallback value')
  }
