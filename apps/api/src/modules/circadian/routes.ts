...
router.get(
  '/phases',
  asyncHandler(circadianController.getPhases.bind(circadianController)),
)
...
router.get(
  '/current-phase',
  asyncHandler(circadianController.getCurrentPhase.bind(circadianController)),
)
...
router.get(
  '/health',
  asyncHandler(circadianController.getHealth.bind(circadianController)),
)
