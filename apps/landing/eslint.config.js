...
export default [
  ...
  // Configuración específica para archivos Vue (Landing page)
  {
    name: 'vue-files',
    files: ['**/*.vue'],
    languageOptions: {
    ...
    rules: {
      ...
      // Reglas específicas para Vue3/Landing
      'vue/multi-word-component-names': 'off',
      'vue/no-v-html': 'warn',
      'vue/require-default-prop': 'error',
      'vue/require-prop-types': 'error',
      'vue/no-unused-vars': 'error',
      'vue/no-multiple-template-root': 'off', // Vue3 permite múltiples roots
      'vue/no-v-model-argument': 'off', // Vue3 soporta argumentos en v-model
    },
  },
