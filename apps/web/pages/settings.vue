    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-3 gap-3">
              <!-- Tema claro -->
              <button @click="changeTheme('light')" :class="[
                ...
                <div class="text-center">
                  ...
                  <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Claro</p>
                </div>
              </button>
              ...
              <button @click="changeTheme('dark')" :class="[
                ...
                <div class="text-center">
                  ...
                  <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Oscuro</p>
                </div>
              </button>

              <!-- Tema del sistema -->
              <button @click="changeTheme('system')" :class="[
                'p-3 rounded-lg border-2 transition-all duration-200',
                ...
                <div class="text-center">
                  ...
                  <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Sistema</p>
                </div>
              </button>
            </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="space-y-4">
          <!-- Exportar datos -->
          <button
            class="w-full flex items-center justify-between p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
...
// Función para cambiar tema específico
