  ...
  const socialPosts = ref([
    {
      ...
      content: {
        ...
        description:
          'Repeat aloud what you hear while studying languages to improve pronunciation and fluency',
        technique: 'Shadowing',
        category: 'Languages',
        ...
        research:
          'Based on research by Alexander Arguelles showing 40% improvement in pronunciation accuracy',
        sources: [
          {
        ...
        personalExperience:
          'I applied this for 2 weeks studying English and my pronunciation improved by 80%. At first I felt weird talking to myself, but it works incredibly well. The key is consistency and choosing content at your level.',
      },
      interactions: {
        likes: 47,
        comments: 12,
      ...
      comments: [
        {
          ...
          content:
            '¡Excelente técnica! La he usado para estudiar francés y funciona increíblemente bien.',
    ...
    },
    {
      ...
      content: {
        ...
        description:
          'Esta canción está científicamente diseñada para reducir la ansiedad. Perfecta para sesiones de estudio intenso.',
    ...
    },
    {
      ...
      content: {
        ...
        description:
          'Después de 3 meses usando la técnica de repetición espaciada, finalmente logré mi meta de 100 horas.',
        achievement: {
    ...
    },
    {
      ...
      content: {
        ...
        cons: ['Algunas clases son muy largas', 'Falta más interacción en vivo'],
        recommendation:
          'Lo recomiendo para estudiantes serios de historia. El contenido es de alta calidad.',
    ...
    },
    {
      ...
      content: {
        ...
        description:
          'Después de meses probando diferentes configuraciones, finalmente encontré el setup ideal para estudiar programación.',
    ...
    },
    {
      ...
      content: {
        ...
        excerpt:
          'Descubre técnicas científicamente probadas para mantener tu atención durante largas sesiones de estudio.',
