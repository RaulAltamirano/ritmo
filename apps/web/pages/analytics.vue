        ...
        <div class="space-y-4">
          ...
          >
            ...
            <div class="flex items-center space-x-2">
              ...
              <span
                class="text-sm font-medium text-gray-900 dark:text-white w-8 text-right"
              >
                {{ category.percentage }}%
              </span>
            </div>
...
<script setup lang="ts">
  ...
  definePageMeta({
    title: 'Analytics',
    description:
      'Insights and progress - Visualize your productivity patterns and achievements',
  })
