<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header de página -->
    <PageHeader title="Tareas" subtitle="Gestiona tus tareas y proyectos" :actions="true">
      <template #actions>
    ...
    <div v-if="showCreateModal || showEditModal"
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto" @click.stop>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Gestiona tus tareas y proyectos de manera eficiente',
    },
  ],
})
