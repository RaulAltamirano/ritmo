<template>
  <div class="min-h-screen bg-canvas">
    ...
    <div class="max-w-full mx-auto px-4 py-3 sm:px-6 lg:px-8 sm:py-6 lg:py-8">
      ...
      <PageHeader
        title="Trending Circadian Backgrounds"
        subtitle="Discover the most popular and voted backgrounds for your daily rhythm phases"
        actions
        size="lg"
      >
        <template #actions>
      ...
      <div v-if="showFilters" class="mb-6">
        <ImageFilters
          :selected-phase="selectedPhaseFilter"
          :phases="phases"
      ...
      <div class="space-y-6">
        ...
        <LoadingState
          v-if="isLoading"
          title="Loading Phase Images"
          description="Discovering trending images from the community"
        ...
        >
          <UserImageCard
            ...
            :image="image"
            :phases="phases"
            @add-to-phase="handleAddToPhase"
            @like-image="handleLikeImage"
          />
        </div>
        ...
        <EmptyState
          ...
          description="Be the first to share an image for this circadian phase"
          :icon="Image"
        >
          <BaseButton
            variant="primary"
      ...
      <ImageUploadModal
        ...
        :phases="phases"
        @update:is-open="showUploadModal = $event"
