<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <!-- Page Header -->
      <PageHeader title="Profile" subtitle="Manage your account settings and personal information" class="mb-8"
        :breadcrumbs="breadcrumbs" />

      <!-- Profile Header -->
      <ProfileHeader :user-display-name="userDisplayName" :user-email="userEmail" :user-initials="userInitials"
        :display-avatar="displayAvatar" :avatar-changed="avatarChanged" :saving="saving"
        :format-join-date="formatJoinDate" :format-last-access="formatLastAccess" @trigger-file-input="triggerFileInput"
        @save-profile="saveProfile" @cancel-avatar-change="cancelAvatarChange" />
      ...
      <BaseCard>
        <div class="space-y-6">
          ...
          <div>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              <div class="flex items-center space-x-4">
                <div class="flex-1">
                  <BaseInput v-model="editableUsername" label="Display Name" placeholder="Enter your display name"
                    @input="onUsernameChange" helper-text="This is the name that will be displayed to other users" />
                </div>
                <div v-if="usernameChanged" class="flex items-center space-x-2">
                  <BaseButton @click="saveUsername" :loading="savingUsername" variant="primary">
          ...
          <div>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h5
                    class="text-md font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">
                    Personal Information
                  </h5>
                  <div class="space-y-3">
                    <div>
                      ...
                      <p class="text-sm text-gray-900 dark:text-white">
                        <ClientOnly>
                          ...
                          <template #fallback>
                            <span class="animate-pulse bg-gray-300 dark:bg-gray-600 rounded w-24 h-4"></span>
                          </template>
                        </ClientOnly>
                      </p>
                    </div>
                    <div>
                      ...
                      <p class="text-sm text-gray-900 dark:text-white">
                        <ClientOnly>
                          ...
                          <template #fallback>
                            <span class="animate-pulse bg-gray-300 dark:bg-gray-600 rounded w-20 h-4"></span>
                          </template>
                        </ClientOnly>
                      </p>
                    </div>
                    <div>
                      ...
                      <p class="text-sm text-gray-900 dark:text-white">
                        <ClientOnly>
                          ...
                          <template #fallback>
                            <span class="animate-pulse bg-gray-300 dark:bg-gray-600 rounded w-32 h-4"></span>
                          </template>
                        </ClientOnly>
                      </p>
                    </div>
                ...
                <div>
                  ...
                  <div class="space-y-3">
                    <div>
                      ...
                      <ClientOnly>
                        <BaseBadge :variant="isUserActive ? 'success' : 'error'"
                          :content="isUserActive ? 'Active' : 'Inactive'"
                          :left-icon="isUserActive ? 'check' : 'alert'" />
                        <template #fallback>
                          <span class="animate-pulse bg-gray-300 dark:bg-gray-600 rounded w-16 h-6"></span>
                        </template>
                      </ClientOnly>
                    </div>
                    ...
                    <div v-if="userTheme">
                      <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Theme</label>
                      <ClientOnly>
                        <BaseBadge variant="info" :content="userTheme" left-icon="info" />
                        <template #fallback>
                          <span class="animate-pulse bg-gray-300 dark:bg-gray-600 rounded w-16 h-6"></span>
                        </template>
                      </ClientOnly>
          ...
          <SecuritySection @change-password="changePassword" @enable-two-factor="enableTwoFactor"
...
const handleProfilePictureChange = async (event: Event) => {
  ...
  try {
    ...
    if (!sanitizedFile) {
      alert('Invalid or unsafe image file')
      return
    }
...
const changePassword = () => {
  ...
  alert('Password change function in development')
}
...
const saveUsername = async () => {
  ...
  try {
    ...
    if (result.success) {
      ...
      alert('Error updating username: ' + result.error)
    }
  } catch (error) {
