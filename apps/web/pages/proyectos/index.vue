<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <PageHeader title="Proyectos" subtitle="Gestiona y organiza tus proyectos de manera eficiente" :actions="true">
      <template #actions>
        <BaseButton variant="outline" class="flex items-center space-x-2" @click="showFilters = !showFilters">
          <Filter :size="16" />
          <span>Filtros</span>
        </BaseButton>
    ...
    <ClientOnly>
      ...
      <div v-if="isLoading" class="text-center py-12">
        ...
        <p class="text-gray-500 dark:text-gray-400">Preparando tu espacio de trabajo</p>
      </div>
...
import { Filter, FolderOpen, Plus } from 'lucide-vue-next'
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Gestiona y organiza tus proyectos de manera eficiente',
    },
  ],
})
