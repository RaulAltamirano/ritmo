<template>
    <BaseModal :is-open="isOpen" title="Terminate All Other Sessions" :close-on-backdrop-click="false"
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <input id="confirm-terminate" v-model="confirmed" type="checkbox"
                    class="mt-1 h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 dark:border-gray-600 rounded"
                    :disabled="loading" />
