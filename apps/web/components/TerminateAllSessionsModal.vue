<template>
  ...
  >
    ...
    <div class="space-y-6">
      <!-- Warning Icon -->
      <div
        class="flex items-center justify-center w-16 h-16 mx-auto bg-red-100 dark:bg-red-900/30 rounded-full"
      >
        <ClientIcon
          name="alert-triangle"
      ...
      <div v-if="sessionCount > 0" class="text-center">
        <div class="inline-flex items-center px-4 py-2 bg-surface-raised rounded-lg">
          ...
          <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
            {{ sessionCount }} active session{{ sessionCount !== 1 ? 's' : '' }} will be
            terminated
          </span>
        </div>
      </div>
        ...
        <div class="flex items-start space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-green-700 dark:text-green-300 mt-1">
              You will stay logged in on this device. All other sessions will be
        ...
        >
          <div class="flex items-start space-x-2">
            ...
            <p class="text-sm text-amber-700 dark:text-amber-300">
              <strong>Warning:</strong> This action cannot be undone. Users will need to
              log in again on their devices.
            </p>
          </div>
        </div>
        ...
        >
          <div class="flex items-start space-x-2">
            ...
            <p class="text-sm text-red-700 dark:text-red-300">
              <strong>Data Loss:</strong> Any unsaved work on other devices may be lost.
