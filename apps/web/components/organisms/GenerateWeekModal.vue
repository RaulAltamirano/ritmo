  ...
  >
    <div class="space-y-6">
      ...
      >
        <div
          v-if="draft"
          class="rounded-2xl border border-outline bg-canvas/60 p-3 shadow-sm dark:bg-surface/40"
        >
          <WeekDraftPreview :draft="draft" :plan-id="planId" />
        </div>
        <p
          v-else
          class="py-6 text-center text-sm text-content-secondary"
        >
          Nothing to apply
        </p>
      </section>
