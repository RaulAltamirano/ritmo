      ...
      <div class="relative">
        ...
        >
          ...
          >
            ...
            <div
              v-else
              class="w-full h-full bg-gray-300 dark:bg-gray-600 animate-pulse rounded-full"
            ></div>
          </div>
          <span class="hidden sm:block text-sm font-medium">
            ...
            <span
              v-else
              class="bg-gray-300 dark:bg-gray-600 animate-pulse rounded w-16 h-4"
            ></span>
          </span>
          <ChevronDown
            :size="12"
            ...
            <div class="flex items-center space-x-3">
              ...
              <div>
                <p class="text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <span
                    v-else
                    class="bg-gray-300 dark:bg-gray-600 animate-pulse rounded w-20 h-4"
                  ></span>
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <span
                    v-else
                    class="bg-gray-300 dark:bg-gray-600 animate-pulse rounded w-24 h-3"
                  ></span>
                </p>
              </div>
            </div>
          ...
          <div class="px-3 py-2 border-b border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                :class="
                  currentIsDark ? 'bg-primary-600' : 'bg-gray-200 dark:bg-gray-700'
                "
                :aria-label="
          ...
          <div class="px-3 py-2 border-b border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                :class="
                  showFloatingTimer ? 'bg-primary-600' : 'bg-gray-200 dark:bg-gray-700'
                "
                :aria-label="
                  showFloatingTimer ? 'Hide floating timer' : 'Show floating timer'
                "
              >
                <span
                  class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
    ...
    <template #mobile-menu>
      ...
      <div class="space-y-1">
        <NuxtLink
          ...
          :key="item.path"
          :to="item.path"
          class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          :class="[
...
<script setup lang="ts">
  ...
  const allNavItems = computed(() => [...primaryNavItems, ...secondaryNavItems])
  ...
  // Single source: $theme from plugins/theme.client.ts
