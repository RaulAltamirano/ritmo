<template>
  <div class="friends-list">
    ...
    <div class="mb-4">
      <SearchBar v-model="searchQuery" v-model:filter-value="filter" placeholder="Search friends by name..."
        :show-filter="true" :filter-options="filterOptions" @update:model-value="onSearchChange"
    ...
    <BaseCard class="p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <!-- Friend Item -->
        <div v-for="friend in paginatedFriends" :key="friend.id"
      ...
      <!-- Pagination -->
      <Pagination :current-page="currentPage" :total-pages="totalPages" :total-items="filteredFriends.length"
        :items-per-page="itemsPerPage" item-label="friends" @page-change="onPageChange" />
    </BaseCard>
  </div>
</template>
