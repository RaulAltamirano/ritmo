  ...
  <div class="trophies-list">
    ...
    <div class="mb-4">
      <SearchBar
        ...
        placeholder="Search trophies by name or description..."
        show-filter
    ...
    <BaseCard class="p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Trophy Item -->
        <div
          v-for="trophy in paginatedTrophies"
          :key="trophy.id"
        ...
        >
          <div class="w-12 h-12 mb-3 flex items-center justify-center">
            <Trophy
              class="w-8 h-8"
              :class="[trophy.earned ? 'text-yellow-500' : 'text-gray-400']"
            />
          </div>
          <h5
            class="text-sm font-medium text-gray-900 dark:text-white text-center mb-1"
          >
            {{ trophy.name }}
          </h5>
          ...
          <div class="mt-2">
            <BaseBadge
              :variant="trophy.earned ? 'success' : 'secondary'"
              :content="trophy.earned ? 'Earned' : 'Locked'"
              :left-icon="trophy.earned ? 'check' : 'x'"
              size="xs"
            />
          </div>
        </div>
      ...
      <Pagination
        ...
        :total-items="filteredTrophies.length"
