<template>
  <div class="calendar-container">
    ...
    <div
      class="calendar-header bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6"
    >
    ...
    <div
      class="calendar-main bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden"
    >
      <FullCalendar
        ref="calendarRef"
