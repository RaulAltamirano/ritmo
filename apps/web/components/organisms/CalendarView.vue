<template>
  <div class="calendar-container">
    ...
    <div
      class="calendar-header bg-surface rounded-xl shadow-sm border border-outline p-4 mb-6"
    >
    ...
    <div
      class="calendar-main bg-surface rounded-xl shadow-sm border border-outline overflow-hidden"
    >
      <FullCalendar
        ref="calendarRef"
