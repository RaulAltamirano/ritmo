<template>
  <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
    <div class="bg-surface rounded-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
      <!-- Header -->
        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
            <button
              ...
              class="flex items-center space-x-3 p-3 rounded-lg border-2 transition-colors"
              :class="[
                selectedType === type.value
                  ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20'
                  : 'border-outline hover:border-gray-300 dark:hover:border-gray-600',
              ]"
            >
              <component
                :is="type.icon"
          ...
          <div v-if="selectedType === 'technique'" class="space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="Ej: Técnica Pomodoro Modificada"
                class="w-full px-3 py-2 border border-outline-strong rounded-lg bg-surface text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  class="w-full px-3 py-2 border border-outline-strong rounded-lg bg-surface text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
          ...
          <div v-else-if="selectedType === 'image'" class="space-y-4">
            <div>
              ...
              <input
                v-model="formData.title"
                type="text"
                placeholder="Ej: Mi setup de estudio perfecto"
                class="w-full px-3 py-2 border border-outline-strong rounded-lg bg-surface text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="estudio, motivación, setup"
                  class="w-full px-3 py-2 border border-outline-strong rounded-lg bg-surface text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
          ...
          <div v-else-if="selectedType === 'review'" class="space-y-4">
            <div>
              ...
              <input
                v-model="formData.title"
                type="text"
                placeholder="Ej: Reseña del curso de React"
                class="w-full px-3 py-2 border border-outline-strong rounded-lg bg-surface text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <div class="flex items-center space-x-2">
                ...
                >
                  <Star
                    :class="i <= formData.rating ? 'fill-current' : ''"
                    class="h-6 w-6"
                  />
                </button>
          ...
          <div v-else-if="selectedType === 'article'" class="space-y-4">
            <div>
              ...
              <input
                v-model="formData.title"
                type="text"
                placeholder="Ej: Cómo mejorar tu concentración"
                class="w-full px-3 py-2 border border-outline-strong rounded-lg bg-surface text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
      ...
      <!-- Footer -->
      <div class="flex items-center justify-end space-x-3 p-6 border-t border-outline">
        <button
          @click="$emit('close')"
...
<script setup lang="ts">
  ...
  import { X, Lightbulb, Music, Image, Trophy, Star, FileText } from 'lucide-vue-next'
  ...
  const canCreatePost = computed(() => {
    ...
    switch (selectedType.value) {
      ...
      case 'trophy':
        return (
          formData.value.achievementName.trim() && formData.value.description.trim()
        )
      case 'review':
