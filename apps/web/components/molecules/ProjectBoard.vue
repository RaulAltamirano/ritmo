    ...
    >
      ...
      <div class="flex flex-1 flex-wrap gap-2 justify-end items-center">
        ...
        <select
          ...
          class="px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
        >
