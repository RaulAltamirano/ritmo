<template>
  <div class="flex flex-col gap-0">
    ...
    <template v-if="completedTasks.length > 0">
      <div
        data-testid="completed-divider"
        class="flex items-center gap-3 mt-4 mb-3"
      >
        <span class="text-xs font-medium text-gray-400 dark:text-gray-500 flex-shrink-0">
...
<script setup lang="ts">
  ...
  const { onGripKeydown, isGrabbed, announce: keyboardAnnounce } = useSortableKeyboard({
    items: keyboardItems,
