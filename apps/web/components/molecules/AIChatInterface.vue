<template>
  <div
    class="ai-chat-interface bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 flex flex-col h-full shadow-soft"
  >
    <!-- Header minimalista -->
    <div
    ...
    >
      ...
      <transition name="fade">
        <div
          v-if="showMenu"
          class="absolute right-4 top-16 z-20 w-40 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2"
        >
          <button
            @click="clearChat"
            class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
      ...
      <div v-if="messages.length === 0" key="welcome" class="text-center py-12">
        ...
        <div class="flex flex-col gap-2 max-w-xs mx-auto">
          <button
            ...
            class="flex items-center gap-2 px-4 py-2 bg-gray-50 dark:bg-gray-800 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded-lg transition-colors text-sm text-gray-700 dark:text-gray-300"
          >
    ...
    <transition name="slide-fade">
      <div
        ...
        class="border-t border-gray-100 dark:border-gray-800 p-4 bg-gray-50 dark:bg-gray-900/60"
      >
        ...
        <div class="flex flex-col gap-2">
          <button
            ...
            :key="suggestion.id"
            @click="sendSuggestionMessage(suggestion.text)"
            class="flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded-lg transition-colors text-sm text-gray-700 dark:text-gray-300"
          >
