<template>
  <div
    class="bg-surface rounded-lg shadow-sm border border-outline p-6 hover:shadow-md transition-all duration-200 cursor-pointer group"
  ...
  >
    ...
    <h3
      class="text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200"
    >
      {{ project.name }}
    </h3>
