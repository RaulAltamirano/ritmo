<template>
  ...
  >
    ...
    >
      ...
      <div class="p-6 space-y-4">
        ...
        <div v-if="event.extendedProps?.category">
          ...
          <span
            ...
            :class="[getCategoryColor(event.extendedProps.category)]"
          >
        ...
        <div v-if="event.extendedProps?.priority">
          ...
          <span
            class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium"
            :class="[getPriorityColor(event.extendedProps.priority)]"
          >
        ...
        <!-- Tareas relacionadas -->
        <div
          v-if="event.extendedProps?.taskIds && event.extendedProps.taskIds.length > 0"
        >
          <label
          ...
          <div class="space-y-2">
            <div
              ...
              :key="taskId"
              class="flex items-center justify-between p-2 bg-surface-raised/50 rounded-lg"
            >
      ...
      <!-- Acciones -->
      <div class="p-6 border-t border-outline flex items-center gap-3">
        <BaseButton variant="outline" @click="closeModal" class="flex-1">
          Cerrar
        </BaseButton>
        ...
        <BaseButton variant="destructive" @click="deleteEvent" class="flex-1">
...
<script setup lang="ts">
  ...
  import { Calendar, Edit, ExternalLink, Trash2, X } from 'lucide-vue-next'
