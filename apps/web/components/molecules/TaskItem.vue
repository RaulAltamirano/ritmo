<template>
  <div
    :class="[
      'relative bg-surface/80 rounded-xl border transition-all duration-300 overflow-visible group backdrop-blur-sm',
      task.completed
...
<script setup lang="ts">
  ...
  const openEditModal = () => {
    ...
    selectedTimerMode.value =
      timerModes.find(mode => mode.duration === currentDuration) || timerModes[0]
