                    ...
                    <div class="hidden sm:flex gap-6">
                            ...
                            <div class="text-center">
                                <div class="relative inline-block">
                                    ...
                                    <div class="flame-number-container">
                                        ...
                                        <!-- Number inside flame -->
                                        <div class="streak-number-integrated text-6xl font-black text-white mb-2">
                                            {{ streak }}
                                        </div>
                        ...
                        <div class="w-[70%]">
                            <div class="flex items-center justify-between mb-4">
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Weekly
                                    Progress</span>
                                <span class="text-sm font-bold text-blue-600 dark:text-blue-400">{{ streak }} / 7</span>
                            </div>

                            <!-- Enhanced progress bar container -->
                            <div class="relative h-4 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden mb-6">
                                <div class="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600 rounded-full transition-all duration-2000 ease-out progress-fill"
                                ...
                                <!-- Progress bar glow -->
                                <div class="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-400/20 to-blue-600/20 rounded-full blur-sm transition-all duration-2000 ease-out"
                                    :style="{ width: `${(streak / 7) * 100}%` }">
                                </div>
                            </div>
                            ...
                            <div class="flex justify-between">
                                <div v-for="(dayName, index) in weekDays" :key="index"
                                    class="flex flex-col items-center space-y-2">
                                    <div :class="[
                                        'w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all duration-700 ease-out day-indicator',
                                        (index + 1) <= streak
                                            ? 'bg-blue-500 border-blue-500 shadow-lg shadow-blue-500/30 scale-110'
                                            : 'bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 hover:scale-105',
                                    ]">
                                        <Check v-if="(index + 1) <= streak"
                                            class="text-white w-4 h-4 animate-check-appear" />
                                        <span v-else class="text-gray-400 dark:text-gray-500 text-xs font-medium">{{
                                            index + 1 }}</span>
                                    </div>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 font-medium">{{ dayName
                                        }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="relative inline-block">
                                ...
                                <div class="flame-number-container">
                                    ...
                                    <!-- Number inside flame -->
                                    <div class="streak-number-integrated text-5xl font-black text-white mb-1">
                                        {{ streak }}
                                    </div>
                                    <!-- Floating particles effect -->
                                    <div class="particles-container">
...
@keyframes number-aurora {
    ...
    100% {
        ...
        filter:
            drop-shadow(0 0 30px rgba(59, 130, 246, 0.4)) drop-shadow(0 0 60px rgba(96, 165, 250, 0.2)) drop-shadow(0 0 90px rgba(147, 197, 253, 0.1));
    }
    ...
    25% {
        ...
        filter:
            drop-shadow(0 0 35px rgba(96, 165, 250, 0.5)) drop-shadow(0 0 70px rgba(147, 197, 253, 0.3)) drop-shadow(0 0 105px rgba(191, 219, 254, 0.15));
    }
    ...
    50% {
        ...
        filter:
            drop-shadow(0 0 40px rgba(147, 197, 253, 0.6)) drop-shadow(0 0 80px rgba(191, 219, 254, 0.4)) drop-shadow(0 0 120px rgba(219, 234, 254, 0.2));
    }
...
@keyframes number-glow-subtle {
    ...
    100% {
        ...
        filter:
            drop-shadow(0 0 15px rgba(59, 130, 246, 0.3)) drop-shadow(0 0 30px rgba(96, 165, 250, 0.15));
    }
    ...
    50% {
        ...
        filter:
            drop-shadow(0 0 20px rgba(96, 165, 250, 0.4)) drop-shadow(0 0 40px rgba(147, 197, 253, 0.2));
    }
}
...
@keyframes number-morph {
    ...
    100% {
        filter:
            drop-shadow(0 0 30px rgba(59, 130, 246, 0.4)) drop-shadow(0 0 60px rgba(96, 165, 250, 0.2)) drop-shadow(0 0 90px rgba(147, 197, 253, 0.1)) hue-rotate(0deg);
    }

    33% {
        filter:
            drop-shadow(0 0 35px rgba(96, 165, 250, 0.5)) drop-shadow(0 0 70px rgba(147, 197, 253, 0.3)) drop-shadow(0 0 105px rgba(191, 219, 254, 0.15)) hue-rotate(10deg);
    }

    66% {
        filter:
            drop-shadow(0 0 40px rgba(147, 197, 253, 0.6)) drop-shadow(0 0 80px rgba(191, 219, 254, 0.4)) drop-shadow(0 0 120px rgba(219, 234, 254, 0.2)) hue-rotate(-5deg);
    }
}
