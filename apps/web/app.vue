  ...
  <div id="app">
    ...
    >
      <div class="flex flex-col items-center justify-center gap-5 text-center">
        ...
        >
          <rect x="10" y="22" width="3" height="8" rx="1.5" fill="currentColor" class="bar bar-1" />
          <rect x="17" y="16" width="3" height="14" rx="1.5" fill="currentColor" class="bar bar-2" />
          <rect x="24" y="20" width="3" height="10" rx="1.5" fill="currentColor" class="bar bar-3" />
          <rect x="31" y="12" width="3" height="18" rx="1.5" fill="currentColor" class="bar bar-4" />
        </svg>

        <p class="m-0 max-w-[350px] animate-[fadeInOut_1.5s_ease-in-out] text-sm font-medium leading-snug tracking-wide text-content-secondary opacity-90">
          {{ currentQuote }}
        </p>
      </div>
    </div>
