<template>
  <div class="min-h-screen bg-canvas">
    <!-- Navigation -->
    <nav
      class="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-700/50 shadow-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center space-x-4">
            ...
            <button @click="toggleDarkMode"
              class="p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-surface-raised transition-all duration-200"
            ...
            <!-- GitHub button -->
            <a href="https://github.com/yourusername/ritmo" target="_blank" rel="noopener noreferrer"
              class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium">
              GitHub
            </a>
            ...
            <button @click="toggleMobileMenu"
              class="md:hidden p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-surface-raised transition-all duration-200"
        ...
        <!-- Mobile menu -->
        <div v-if="showMobileMenu" class="md:hidden py-4 border-t border-outline">
          <div class="space-y-2">
            <a href="#features"
    ...
    <!-- Footer -->
    <footer class="bg-canvas border-t border-outline">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid md:grid-cols-4 gap-8">
          <div class="col-span-2">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-4 max-w-md">
              My personal study tool that combines cognitive science with AI to help me
              stay organized and learn effectively.
            </p>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              ...
              <li>
                <a href="#pricing" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Open
                  Source</a>
              </li>
              <li>
                <a href="https://github.com/yourusername/ritmo" target="_blank" rel="noopener noreferrer"
                  class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">GitHub</a>
              </li>
              <li>
                <a href="https://github.com/yourusername/ritmo/issues" target="_blank" rel="noopener noreferrer"
                  class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Issues</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <li>
                <a href="#" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Help Center</a>
              </li>
              <li>
        ...
        <div
          class="border-t border-outline mt-8 pt-8 text-center text-sm text-gray-500 dark:text-gray-400">
          <p>
            &copy; 2024 Ritmo. My personal study tool, open source for the community.
            MIT License.
          </p>
        </div>
      </div>
  ...
  meta: [
    {
      name: 'description',
      content:
        'Study smarter, not harder. Ritmo combines cognitive science with AI to help you organize your day, master proven study techniques, and build lasting learning habits.',
    },
    { name: 'viewport', content: 'width=device-width, initial-scale=1' },
    { charset: 'utf-8' },
  ],
  link: [{ rel: 'icon', type: 'image/svg+xml', href: '/logo-ritmo.svg' }],
})
