...
export function buildMockPlanTimelineTasks(
  ...
  return [
    ...
    {
      id: `mock-plan-shadow-${planId}`,
      name: 'Spanish shadowing',
    ...
    {
      id: `mock-plan-inbox-c-${planId}`,
      name: 'Anki vocab deck',
      title: 'Anki vocab deck',
    ...
    {
      id: `mock-plan-inbox-d-${planId}`,
      name: 'Shadowing practice',
      title: 'Shadowing practice',
      createdAt: new Date(now - 180_000_000),
      projectId: planId,
      category: 'Study',
      priority: 'alta',
      completed: false,
